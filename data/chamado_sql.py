...
"""
OBTER_TODOS = """
SELECT * FROM chamado ORDER BY data DESC;

SELECT * FROM resposta_chamado ORDER BY data DESC;
"""
OBTER_POR_ID = """
SELECT * FROM chamado WHERE id = ?;

SELECT * FROM resposta_chamado WHERE id = ?;
"""